          ...
          <aside className="flex flex-col justify-between py-8 px-6 bg-white" style={{ position: 'fixed', left: 0, top: 0, bottom: 0, width: '260px', borderRight: '1px solid #e2e8f0', zIndex: 50 }}>
            ...
            <div className="flex flex-col gap-4">
              <button 
                ...
                className="flex justify-between items-center p-3 rounded-lg w-full transition"
                style={{ color: 'var(--text-main)', backgroundColor: 'var(--card-bg)', border: '1px solid var(--card-border)', cursor: 'pointer' }}
              >
              ...
              <button 
                ...
                style={{ color: 'var(--danger)', backgroundColor: 'var(--danger-bg)', border: '1px solid rgba(239, 68, 68, 0.2)', cursor: 'pointer' }}
              >
